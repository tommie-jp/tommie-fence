...
\draw (b3) to[C, l_=$C_{1}$, a^=$1000\,\mathrm{p}\mathrm{F}$] (b5); % line 4
\draw (b5) to[L, l_=$\mathrm{ESL}$, a^=$1.2\,\mathrm{n}\mathrm{H}$] (b7); % line 5
\draw (b7) to[R, l_=$\mathrm{ESR}$, a^=$0.1\,\Omega$] (b9); % line 6
\node[ground] at (c2) {}; % line 7
\node[ground] at (c10) {}; % line 8
\draw (part-J1.pin 1) -- (b3); % line 10
\draw (b9) -- (b10); % line 11
\draw (b10) -- (c10); % line 11
...
\path (circuittitle.south west) rectangle ++(16.703,0.853);
\end{circuitikz}
\end{document}
