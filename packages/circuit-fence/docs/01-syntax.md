...
| 72 | `dip8` | DIP の IC (8 ピン) | `1` 〜 `8` |
| 73 | `dip14` | DIP の IC (14 ピン) | `1` 〜 `14` |
| 74 | `dip16` | DIP の IC (16 ピン) | `1` 〜 `16` |
| 75 | `dip20` | DIP の IC (20 ピン) | `1` 〜 `20` |
| 76 | `dip28` | DIP の IC (28 ピン) | `1` 〜 `28` |
| 77 | `dip40` | DIP の IC (40 ピン) | `1` 〜 `40` |
...
| --- | --- | --- | --- |
| 多端子 (既定) | ○ | ○ | |
| `dip8`〜`dip40` | ○ | ✗ | 反転すると足番号も型番も**鏡文字**になる |
