...
| 83 | `regulator` | 三端子レギュレータ | `in` (`1`) / `gnd` (`2`) / `out` (`3`) |
| 84 | `sip2` | ピンヘッダ (2 ピン) | `1` 〜 `2` |
| 85 | `sip3` | ピンヘッダ (3 ピン) | `1` 〜 `3` |
| 86 | `sip4` | ピンヘッダ (4 ピン) | `1` 〜 `4` |
| 87 | `sip5` | ピンヘッダ (5 ピン) | `1` 〜 `5` |
| 88 | `sip6` | ピンヘッダ (6 ピン) | `1` 〜 `6` |
| 89 | `sip8` | ピンヘッダ (8 ピン) | `1` 〜 `8` |
| 90 | `sip10` | ピンヘッダ (10 ピン) | `1` 〜 `10` |
| 91 | `sip20` | ピンヘッダ (20 ピン) | `1` 〜 `20` |
| 92 | `sip40` | ピンヘッダ (40 ピン) | `1` 〜 `40` |
| 93 | `pico` | Pico | `GP0` 〜 `VBUS` (実物の印字) |
| 94 | `pico-w` | Pico W | 同上 |
| 95 | `pico2` | Pico 2 | 同上 |
| 96 | `pico2-w` | Pico 2 W | 同上 |
