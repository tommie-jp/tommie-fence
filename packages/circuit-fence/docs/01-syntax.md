...
| 83 | `sip2` | ピンヘッダ (2 ピン) | `1` 〜 `2` |
| 84 | `sip3` | ピンヘッダ (3 ピン) | `1` 〜 `3` |
| 85 | `sip4` | ピンヘッダ (4 ピン) | `1` 〜 `4` |
| 86 | `sip5` | ピンヘッダ (5 ピン) | `1` 〜 `5` |
| 87 | `sip6` | ピンヘッダ (6 ピン) | `1` 〜 `6` |
| 88 | `sip8` | ピンヘッダ (8 ピン) | `1` 〜 `8` |
| 89 | `sip10` | ピンヘッダ (10 ピン) | `1` 〜 `10` |
| 90 | `sip20` | ピンヘッダ (20 ピン) | `1` 〜 `20` |
| 91 | `sip40` | ピンヘッダ (40 ピン) | `1` 〜 `40` |
| 92 | `pico` | Pico | `GP0` 〜 `VBUS` (実物の印字) |
| 93 | `pico-w` | Pico W | 同上 |
| 94 | `pico2` | Pico 2 | 同上 |
| 95 | `pico2-w` | Pico 2 W | 同上 |
...
ピンヘッダ (`sipN`) も**数は実体配線図の 2 つと同じ表**。回路図では箱の片側に
