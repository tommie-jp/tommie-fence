...
\path (-0.07,-4.193) rectangle (2.47,-3.007); % line 28
\node[anchor=west, inner sep=0, circuitnotemark, font=\large] at (1.2,-3.6) {X}; % line 28
\path (3.53,-4.193) rectangle (6.07,-3.007); % line 29
\node[anchor=west, inner sep=0, circuitnotemark, font=\large] at (4.8,-3.6) {X}; % line 29
\path (6.876,-4.193) rectangle (9.924,-3.007); % line 30
\node[anchor=west, inner sep=0, circuitnotemark, font=\large] at (8.4,-3.6) {X}; % line 30
\path (-0.197,-8.993) rectangle (2.597,-7.807); % line 31
\node[anchor=west, inner sep=0, circuitnotemark, font=\large] at (1.2,-8.4) {X}; % line 31
\path (3.403,-8.993) rectangle (6.197,-7.807); % line 32
\node[anchor=west, inner sep=0, circuitnotemark, font=\large] at (4.8,-8.4) {X}; % line 32
\path (6.876,-8.993) rectangle (9.924,-7.807); % line 33
\node[anchor=west, inner sep=0, circuitnotemark, font=\large] at (8.4,-8.4) {X}; % line 33
\end{circuitikz}
\end{document}
