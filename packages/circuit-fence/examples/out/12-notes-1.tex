...
\foreach \x in {0,2,4,6} {\foreach \y in {0,-2,-4} {\fill[gray] (\x,\y) circle (1.1pt);}}
...
\draw (a3) -- (a4); % line 8
\node[circ] at (a3) {};
\draw[circuitnotered] (2,0) circle (0.9); % line 10
\path (0,-6.226) rectangle (3.722,-5.774); % line 11
\node[anchor=west, circuitnotemark, font=\footnotesize] at (0,-6) {X}; % line 11
\path (0,-8.226) rectangle (3.553,-7.774); % line 12
