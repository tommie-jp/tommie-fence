...
\draw ($(part-U1.-)+(0.44,0.13)$) -- ++(0.28,0); % line 2
\node[transformer core] (part-T1) at (b7) {}; % line 3
...
\path (0,-4.193) rectangle (4.572,-3.007); % line 13
\node[anchor=west, inner sep=0, circuitnotemark, font=\large] at (0,-3.6) {X}; % line 13
\path (6,-4.193) rectangle (11.842,-3.007); % line 14
\node[anchor=west, inner sep=0, circuitnotemark, font=\large] at (6,-3.6) {X}; % line 14
\end{circuitikz}
\end{document}
