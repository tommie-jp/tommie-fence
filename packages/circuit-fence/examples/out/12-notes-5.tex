...
\path (4,-4.593) rectangle (8,-3.407); % line 6
\node[anchor=west, inner sep=0, circuitnotemark, font=\large] at (4,-4) {X}; % line 6
\draw[circuitnotered] (4,-8) circle (0.9); % line 7
\path (1.523,-8.593) rectangle (6.477,-7.407); % line 8
\node[anchor=west, inner sep=0, circuitnotemark, font=\large] at (4,-8) {X}; % line 8
\draw[circuitnotered] (4,-12) circle (0.9); % line 9
\path (-0.255,-12.593) rectangle (4,-11.407); % line 10
\node[anchor=west, inner sep=0, circuitnotemark, font=\large] at (4,-12) {X}; % line 10
\path (4,-16.593) rectangle (7.937,-15.407); % line 11
\node[anchor=west, inner sep=0, circuitnotemark, font=\large\bfseries] at (4,-16) {X}; % line 11
\path (10,-8.382) rectangle (20.279,0.593); % line 12
...
\node[anchor=west, inner sep=0, circuitnotemark, font=\large] at (10,-7.789) {X}; % line 12
