...
\draw (a3) -- (a4); % line 8
\node[circ] at (a3) {};
\path (10,-5.588) rectangle (14.724,0.395); % line 10
...
\node[anchor=west, inner sep=0, circuitnotemark, font=\footnotesize] at (10,-4.868) {X}; % line 10
\node[anchor=west, inner sep=0, circuitnotemark, font=\footnotesize] at (10,-5.193) {X}; % line 10
\end{circuitikz}
\end{document}
