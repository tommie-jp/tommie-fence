...
```text
perf: 7 行目: R2.1 (a5) がどこにもつながっていません。…
perf: 7 行目: R2.2 (c5) がどこにもつながっていません。…
perf: 7 行目: R1 と R2 の胴が重なっています (実物では両方を挿せません)
perf: 8 行目: R3 (resistor) の足の間隔が狭すぎます (e3 と e4)。…
perf: 9 行目: D1.1 (g3) がどこにもつながっていません。…
perf: 12 行目: g10 -- g12 は部品の足を 1 つもつないでいません
```
