...
書いた値が決める — 図01 の `10k` が 4 帯なのは、2 桁で書ける値だから。
...
parts:
  J1: sma/female c3 c5
  J2: sma/male c11 c13
  R1: resistor e3 e6 26r1
  R2: resistor e8 e11 26r1
  R3: resistor e7 h7 35r7
wires:
  - c3 -- e3
  - e6 -- e7
  - e7 -- e8
...
parts:
  ...
  R1: resistor e3 e6 26r1
  R2: resistor e11 e14 26r1
  R3: resistor e8 h8 35r7
wires:
  - e1 -- e3
  - e6 -- e8
  - e8 -- e11
...
中身は図02・図04 と同じ **50Ω 系の 10 dB T 型アッテネータ** (直列 26.1Ω が
2 本、分岐に 35.7Ω)。**違うのは入口だけ** — 縦置きの SMA を端面実装に替えると、
